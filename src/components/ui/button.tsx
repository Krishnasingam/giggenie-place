  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        accent: "bg-gradient-accent text-accent-foreground font-semibold shadow-soft hover:shadow-glow hover:scale-[1.02] active:scale-[0.98]",
        hero: "bg-card text-foreground font-semibold hover:bg-card/90 shadow-medium hover:-translate-y-0.5",
        heroOutline: "border-2 border-card/30 text-card hover:bg-card/10 hover:border-card/50 hover:-translate-y-0.5",
      },
      size: {
